      ...
      {isGuest && showGuestHint && (
        <div style={{
          ...
          <span>
            ...
            {' '}Run <code style={{ background: 'var(--bg)', padding: '0 4px' }}>npm start</code> to serve the project,
            or <code style={{ background: 'var(--bg)', padding: '0 4px' }}>npm run dev</code> if you want live reload while editing.
            Then open the <strong>Ports</strong> panel and forward port <strong>3000</strong>.
          </span>
          <button
